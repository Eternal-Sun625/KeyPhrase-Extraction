...
class Model(object):
    ...
    def __init__(self,
        ...
        with tf.variable_scope('loss'):
            ...
            loss1 = tf.nn.sparse_softmax_cross_entropy_with_logits(logits=sy, labels=label_y)
            label_z = tf.reshape(self.input_z, [-1])
            loss2 = tf.nn.sparse_softmax_cross_entropy_with_logits(logits=sz, labels=label_z)
